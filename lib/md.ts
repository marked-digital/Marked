...
export const STACK_TOOLS: StackTool[] = [
  ...
  { name: "Avalara", cat: "ERP & Operations", mono: "Av", color: "#FF8200", role: "Tax compliance", why: "Automated sales tax and VAT across every market.", localLogo: "avalara" },
  { name: "Vertex", cat: "ERP & Operations", mono: "Vx", color: "#0091DA", role: "Tax automation", why: "Enterprise tax determination for cross-border sales.", localLogo: "vertex" },
  { name: "Akeneo", cat: "PIM & Syndication", mono: "Ak", color: "#9452BA", role: "Product information", why: "A single source of truth for product data across channels.", localLogo: "akeneo" },
  { name: "Salsify", cat: "PIM & Syndication", mono: "Sa", color: "#FF492C", role: "PXM & syndication", why: "Manages and distributes rich product content to retailers.", localLogo: "salsify" },
  { name: "Feedonomics", cat: "PIM & Syndication", mono: "Fe", color: "#00B5E2", role: "Feed management", why: "Optimizes product feeds for every marketplace and channel.", localLogo: "feedonomics" },
  ...
  { name: "Cloudflare", cat: "Cloud & Infrastructure", mono: "CF", color: "#F38020", role: "CDN & security", why: "Global CDN, DNS, and DDoS protection at the edge.", icon: "cloudflare" },
  { name: "Google BigQuery", cat: "Data & Warehousing", mono: "BQ", color: "#669DF6", role: "Data warehouse", why: "Serverless analytics over all your marketing and sales data.", icon: "googlebigquery" },
  { name: "Amazon Redshift", cat: "Data & Warehousing", mono: "RS", color: "#8C4FFF", role: "Data warehouse", why: "Petabyte-scale warehousing for unified reporting.", localLogo: "redshift" },
  ...
  { name: "Visual Studio Code", cat: "Development", mono: "VS", color: "#007ACC", role: "Code editor", why: "The editor our engineers build and ship in every day.", localLogo: "vscode" },
  { name: "Postman", cat: "Development", mono: "Pm", color: "#FF6C37", role: "API tooling", why: "Builds and tests the integrations that wire the stack together.", icon: "postman" },
  { name: "Docker", cat: "Development", mono: "Dk", color: "#2496ED", role: "Containers", why: "Reproducible environments from local to production.", icon: "docker" },
  { name: "Figma", cat: "Design & Productivity", mono: "Fg", color: "#F24E1E", role: "Design", why: "Where storefronts and campaigns are designed and reviewed.", icon: "figma" },
  { name: "Jira", cat: "Design & Productivity", mono: "Jr", color: "#0052CC", role: "Project tracking", why: "Plans and tracks every build across the team.", icon: "jira" },
  { name: "Confluence", cat: "Design & Productivity", mono: "Cf", color: "#2684FF", role: "Knowledge base", why: "Documentation and playbooks that keep delivery consistent.", icon: "confluence" },
  { name: "Airtable", cat: "Design & Productivity", mono: "At", color: "#18BFFF", role: "Ops database", why: "Flexible databases for content calendars and launch ops.", icon: "airtable" },
  ...
  { name: "Power BI", cat: "Analytics & Tags", mono: "PB", color: "#F2C811", role: "BI dashboards", why: "Executive dashboards that unify data across the stack.", localLogo: "powerbi" },
  { name: "Looker Studio", cat: "Analytics & Tags", mono: "LS", color: "#4285F4", role: "Reporting", why: "Shareable marketing and revenue dashboards.", localLogo: "looker-studio" },
  { name: "Tableau", cat: "Analytics & Tags", mono: "Tb", color: "#E97627", role: "Data visualization", why: "Deep-dive visual analysis for large datasets.", localLogo: "tableau" },
  { name: "Hotjar", cat: "Conversion Rate Optimization (CRO)", mono: "Hj", color: "#FF3C00", role: "Behavior insights", why: "Heatmaps and recordings that surface where users drop off.", icon: "hotjar" },
  { name: "Optimizely", cat: "Conversion Rate Optimization (CRO)", mono: "Op", color: "#0037FF", role: "Experimentation", why: "A/B and multivariate testing to lift conversion rates.", localLogo: "optimizely" },
  { name: "PageFly", cat: "Conversion Rate Optimization (CRO)", mono: "Pf", color: "#6E56CF", role: "Landing pages", why: "High-converting, no-code landing pages for storefronts.", localLogo: "pagefly" },
  { name: "VWO", cat: "Conversion Rate Optimization (CRO)", mono: "Vw", color: "#FF5C35", role: "Testing & personalization", why: "Experimentation and personalization to grow conversions.", localLogo: "vwo" },
  ...
  { name: "Freshdesk", cat: "Support", mono: "Fd", color: "#25C16F", role: "Support desk", why: "Multichannel ticketing for fast-scaling support teams.", localLogo: "freshdesk" },
  { name: "Contentful", cat: "Content Management (CMS)", mono: "Co", color: "#2478CC", role: "Headless CMS", why: "API-first content delivered to any front end or market.", icon: "contentful" },
  { name: "Prismic", cat: "Content Management (CMS)", mono: "Pr", color: "#5163BA", role: "Headless CMS", why: "Slice-based content for fast, marketer-friendly pages.", icon: "prismic" },
  { name: "Drupal", cat: "Content Management (CMS)", mono: "Dr", color: "#0678BE", role: "Enterprise CMS", why: "Structured, multilingual content at enterprise scale.", icon: "drupal" },
  { name: "Adobe Experience Manager", cat: "Content Management (CMS)", mono: "AEM", color: "#FA0F00", role: "Enterprise DXP", why: "Content and assets across global, personalized experiences.", localLogo: "aem" },
  { name: "Sanity", cat: "Content Management (CMS)", mono: "Sn", color: "#F03E2F", role: "Headless CMS", why: "Real-time structured content with a customizable studio.", icon: "sanity" },
  { name: "Shogun", cat: "Content Management (CMS)", mono: "Sho", color: "#5C6AC4", role: "Page builder", why: "Visual landing-page building for commerce storefronts.", localLogo: "shogun" },
  { name: "ButterCMS", cat: "Content Management (CMS)", mono: "Bu", color: "#FCB320", role: "Headless CMS", why: "Blog and content APIs that drop into any stack.", localLogo: "buttercms" },
  { name: "Builder.io", cat: "Content Management (CMS)", mono: "Bi", color: "#7C3AED", role: "Visual CMS", why: "Drag-and-drop content on top of your codebase.", localLogo: "builder-io" },
];
